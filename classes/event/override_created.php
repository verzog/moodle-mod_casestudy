...
/**
 * The override_created event class.
 *
 * @package    mod_casestudy
 * @copyright  2025 SCCA
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class override_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventoverridecreated', 'mod_casestudy');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' created an override for the case study with " .
