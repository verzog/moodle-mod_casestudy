...
/**
 * The mod_casestudy submission created event.
 *
...
class submission_created extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_casestudy');
    }
     ...
     */
    public static function create_from_submission($casestudy, $cm, $submission) {
        $data = [
