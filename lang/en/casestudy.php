...
$string['attemptactions'] = 'Actions for this attempt';
...
$string['casestudysubmissions'] = 'Case study submissions';
...
$string['confirmsubmitdraft'] = 'Submitting this draft will hand it to your assessor for grading. You will not be able to edit it after this. Continue?';
$string['confirmsubmittitle'] = 'Submit this draft for grading?';
...
$string['errorsubmitting'] = 'Could not submit this draft. Please try again or contact your assessor.';
...
$string['formtemplate_help'] = 'Customise the layout of the submission form using HTML and field placeholders.';
$string['grade'] = 'Grade';
...
$string['imageoptimisation'] = 'Image optimisation';
$string['imageoptimisation_desc'] = 'Automatically downscale and re-encode large uploaded images to keep storage use and backup size manageable. Only images larger than the maximum dimension are changed, and only once.';
...
$string['markgrade'] = 'Mark';
$string['markgradenopass'] = 'This case study is graded by points or a rubric, but no "grade to pass" is set. Completion counts satisfactory cases, and without a grade to pass no submission can be marked satisfactory. Set a grade to pass in the Grade section.';
...
$string['nosubmissionsyet'] = 'This student has not submitted any case studies yet.';
...
$string['optimizeimages'] = 'Optimise uploaded images';
$string['optimizeimages_desc'] = 'When enabled, images uploaded to file fields are downscaled to the maximum dimension and re-encoded. Non-image files (e.g. PDFs) are never changed.';
$string['optimizemaxedge'] = 'Maximum image dimension (px)';
$string['optimizemaxedge_desc'] = 'Images whose longest edge exceeds this many pixels are downscaled to it. Larger values preserve more detail but save less storage.';
$string['optimizeonrestore'] = 'Optimise images on restore';
$string['optimizeonrestore_desc'] = 'Also optimise images when restoring a backup, so importing an old course full of large originals does not bloat this site.';
$string['optimizequality'] = 'JPEG quality';
$string['optimizequality_desc'] = 'Quality used when re-encoding JPEG images (1-100). Higher keeps more detail but produces larger files. PNG images are re-encoded losslessly.';
...
$string['privacy:fieldfiles'] = 'Files uploaded to field {$a}';
$string['privacy:gradesgiven'] = 'Grades you have given to other students';
$string['privacy:metadata:casestudy_content'] = 'Content saved for each field of a case study submission.';
$string['privacy:metadata:casestudy_content:content'] = 'The submitted value for the field.';
$string['privacy:metadata:casestudy_content:fieldid'] = 'The field this content belongs to.';
$string['privacy:metadata:casestudy_content:submissionid'] = 'The submission this content belongs to.';
$string['privacy:metadata:casestudy_grades'] = 'Grades and feedback for case study submissions.';
$string['privacy:metadata:casestudy_grades:feedback'] = 'Feedback text given by the grader.';
$string['privacy:metadata:casestudy_grades:grade'] = 'Grade awarded for the submission.';
$string['privacy:metadata:casestudy_grades:graderid'] = 'The user who graded the submission.';
$string['privacy:metadata:casestudy_grades:timecreated'] = 'When the grade was first recorded.';
$string['privacy:metadata:casestudy_grades:timemodified'] = 'When the grade was last updated.';
$string['privacy:metadata:casestudy_grades:userid'] = 'The user who owns the submission being graded.';
$string['privacy:metadata:casestudy_overrides'] = 'Per-user activity overrides (extended deadlines, extra attempts).';
$string['privacy:metadata:casestudy_overrides:maxattempts'] = 'Override maximum attempts for the user.';
$string['privacy:metadata:casestudy_overrides:timeclose'] = 'Override deadline for the user.';
$string['privacy:metadata:casestudy_overrides:userid'] = 'The user the override applies to.';
$string['privacy:metadata:casestudy_submissions'] = 'A student submission to a case study activity.';
$string['privacy:metadata:casestudy_submissions:attempt'] = 'The attempt number for this submission.';
$string['privacy:metadata:casestudy_submissions:groupid'] = 'The group the submission was made on behalf of, if any.';
$string['privacy:metadata:casestudy_submissions:status'] = 'The current workflow status of the submission.';
$string['privacy:metadata:casestudy_submissions:timecreated'] = 'When the submission was created.';
$string['privacy:metadata:casestudy_submissions:timemodified'] = 'When the submission was last modified.';
$string['privacy:metadata:casestudy_submissions:timesubmitted'] = 'When the submission was finalised.';
$string['privacy:metadata:casestudy_submissions:userid'] = 'The user who owns the submission.';
$string['privacy:metadata:core_files'] = 'Files uploaded into case study fields, rich-text editors, and grader feedback.';
$string['privacy:metadata:core_message'] = 'The case study activity sends notifications about submissions and grades via the messaging subsystem.';
$string['privacy:overrides'] = 'Activity overrides applied to your account';
$string['privacy:richtextfiles'] = 'Files embedded in rich-text fields';
$string['privacy:submissionnumber'] = 'Submission attempt {$a}';
$string['privacy:submissions'] = 'Your case study submissions';
$string['progress'] = 'Progress';
$string['reattempt'] = 'Re-attempt';
$string['recreate'] = 'Recreate submission';
$string['repairrichtextapply'] = 'Apply changes';
$string['repairrichtextcmid'] = 'Course module id (cmid)';
$string['repairrichtextcmidall'] = 'blank = whole site';
$string['repairrichtextcounts'] = 'Files present: {$a->present}. Files missing: {$a->missing}.';
$string['repairrichtextdiagnose'] = 'Diagnose';
$string['repairrichtextdone'] = 'Done. Rewrote {$a->rows} content row(s), {$a->urls} URL(s).';
$string['repairrichtextfile'] = 'File';
$string['repairrichtextintro'] = 'Diagnose and repair rich-text image URLs in submission content. "Diagnose" lists each referenced image and whether its file exists; "Preview" reports how many stored URLs would be rewritten to the portable @@PLUGINFILE@@ form, then lets you apply the change. Safe to re-run.';
$string['repairrichtextmissing'] = 'MISSING';
$string['repairrichtextmissinghelp'] = 'Missing files are not in storage for that submission. If the course was restored from a backup that predates rich-text image support, the files were never included and cannot be recovered without a fresh backup/restore.';
$string['repairrichtextneedcmid'] = 'Enter a course module id (cmid) to diagnose a specific activity.';
$string['repairrichtextnoimages'] = 'No rich-text image references found in scope.';
$string['repairrichtextok'] = 'OK';
$string['repairrichtextpreview'] = 'Preview (dry run)';
$string['repairrichtextpreviewheading'] = 'Preview';
$string['repairrichtextresults'] = 'Results';
$string['repairrichtextsubmission'] = 'Submission';
$string['repairrichtexttitle'] = 'Repair rich-text image URLs';
$string['repairrichtextwouldrewrite'] = 'Would rewrite {$a->rows} content row(s), {$a->urls} URL(s) (scanned {$a->scanned}).';
$string['reportcountlegend'] = 'Each figure shows the number of cases, with the number of submission attempts in brackets.';
$string['reportcountmarked'] = 'Marked';
$string['reportcountsatisfactory'] = 'Satisfactory';
$string['reportcountsubmitted'] = 'Submitted';
$string['reportcountunmarked'] = 'Unmarked';
$string['reportcountunsatisfactory'] = 'Unsatisfactory';
...
$string['requiresubmit_help'] = 'Students must click a submit button to finalise their case study submission.';
...
$string['submitdraft'] = 'Submit draft';
$string['submitted'] = 'Submitted';
$string['summaries'] = 'Case Study Summaries';
$string['summariesview'] = 'Summaries View';
$string['suppressnotifications'] = 'Suppress notifications for hidden or completed courses';
$string['suppressnotifications_help'] = 'When set to Yes, this activity does not send notifications (to students or markers) about a student once the course is hidden, or once that student has completed the whole course. A student who holds a current user override (an extension) still receives notifications. When set to No, notifications are always sent.';
$string['suppressnotificationsdefault'] = 'Suppress notifications for hidden or completed courses';
$string['suppressnotificationsdefault_desc'] = 'The default for new case study activities. When enabled, an activity stops notifying about a student once the course is hidden or that student has completed the course, unless the student holds a current override. Each activity can change this on its own settings page.';
...
$string['taskoptimizeimages'] = 'Optimise existing case study images';
